...
public class StudentTemplateController implements Initializable {
  ...
  /**
   * Handles the event when the user clicks on the "AdminAddOrRemove" button.
   * It switches the scene to the AdminAddOrRemove page.
   *
   * @param event The action event triggered by clicking the button
   * @throws IOException If an error occurs while loading the FXML file
   */
  @FXML
  void setStageAdminAddOrRemove(ActionEvent event) throws IOException {
