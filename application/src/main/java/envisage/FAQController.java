...
public class FAQController implements Initializable {
         ...
         */
        String registerforClasses = "Students can not register for classes on Envisage" +
                        " " + "unless stated otherwise by their institution.";
        String contactAdvisor = "Envisage currently does not offer a chat feature" +
                        " " + "for users to communicate with each other.";
        String forgotPassword = "Please click the \"Forgot Password\" link on your" +
                        " " + "designated login screen and follow the instructions.";
        String forgotOthers = "Please contact your institution's administrator or advisor.";
        String viewingGrades = "All grades can be visibile on your \"Student Profile\"" +
                        " " + "under \"Completed Courses\"";
        String declareMajor = "To declare your major, go to your \"Student Profile\"" +
                        " " + "and click on the \"Declare a Major\" button." +
                        " " + "Follow the instructions provided.";
        String deleteAccount = "Please Contact your institution's administrator.";
        String parentAccess = "Envisage does not offer parent access. However, some" +
                        " " + "institutions may have that featue, so please" +
                        " " + "contact your institution's administrator.";
        String classmatesViewGrades = "All accounts are private; only advisors and administrators" +
                        " " + "can view your grades.";
        String studentPay = "Envisage does not require a payment when creating a student account.";
        String transferringAccount = "Accounts can be transferred if the insititution is a university partner" +
        ...
        String graduatingAccount = "Envisage keeps accounts for an infinite amount of time. However, institutions can" +
                        " " + "change the account timeframe, so please check with your insitution's administrator" +
                        " " + "BEFORE graduating.";
        String shareCoursePlanner = "A feature in Settings, \"Share,\" allows you to share any planner version" +
                        " " + "with your peers, but it might be disabled/hidden by some institutions.";

        /**
         * String Section - Software Questions Edition
         */
        String freeSoftwareA = "The software is not free for institutions. However, institutions" +
                        " " + "can pay a set price per student or enroll in a monthly subscription.";
        String freeSoftwareB = "If the institution chooses to pay a set price per student, a bill will be " +
        ...
        String freeSoftwareC = "If the institution decides to enroll in a monthly subscription," +
                        " " + "they will be billed an overall price that is not based on the number" +
                        " " + "of students but a fixed price.";
        String userPay = "Payment is not required for any user when creating or logging in to" +
                        " " + "an account.";
        String ad = "There are no ads on the default website unless changed by the institution.";
        String studentLimit = "There are no student limits for any institution. Envisage can store and" +
                        " " + "manage an endless amount of students.";
        String modifiableCode = "Yes! We aim for a personalizable experience with our software.";
        String internationalInstitution = "Our software can be used and modified to fit foregin languages or foreign institutions.";
        String contactCustomerSupport = "We offer support 24/7. Call us at (803)247 - 3618 or email us at" +
        ...
        public void initialize(URL url, ResourceBundle arg1) {
                ...
                TreeItem<String> contactingAdvisorQuestion = new TreeItem<>(
                                "How do I contact my advisor through Envisage?");
                ...
                TreeItem<String> parentAccessQuestion = new TreeItem<>(
                                "I want to give my parents access. How do I do that?");
                ...
                TreeItem<String> graduatingAccountQuestion = new TreeItem<>(
                                "I am graduating. How long will my account be available?");
                ...
                TreeItem<String> transferringAccountQuestion = new TreeItem<>(
                                "I am transferring. Can I transfer my account to my new instituton?");
                ...
                TreeItem<String> shareCoursePlannerQuestion = new TreeItem<>(
                                "Can I share my course planner with friends?");
                ...
                TreeItem<String> availableInternationalQuestion = new TreeItem<>(
                                "Is this software available for international institutions?");
                ...
                TreeItem<String> contactCustomerSupportQuestion = new TreeItem<>(
                                "How to contact Envisage for Customer Support?");
